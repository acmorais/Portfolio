...
-- Verificando valores nulos ou campos vazios
SELECT * FROM case_zax 
WHERE Nomes_de_medida IS NULL OR Nomes_de_medida = ''
...
SELECT DISTINCT g.Código_do_cliente, 
	Cidade, 
	Estado, 
	CONVERT(VARCHAR, Data_pedido, 103) as Data_pedido, -- Alterar data para dd/mm/aaaa
	l.Numero_Pedido,
	Metodo_De_Pagamento,
	Tipo_Envio,
	l.qtde_lojas_pedido,
